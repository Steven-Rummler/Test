...
namespace BlowOut.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //{
            //    if (instrument.ClientID == client.ClientID)
            //    {
            //        instrument.ClientID = null;
            //    }
            //}
            
            List<Instrument> clientInstruments = db.Instruments.SqlQuery(("SELECT * FROM Instrument WHERE ClientID = " + id)).ToList();
            foreach (Instrument instrument in clientInstruments)
            {
                instrument.ClientID = null;
            }
